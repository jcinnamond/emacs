...
(let* ((bg-color "#090909")
       (fg-color "#D6D6D6")
       (contrast-1-color (color-lighten-name "#cd8fa3" 10))
       (low-contrast-color (color-desaturate-name contrast-1-color 10))
       (contrast-2-color "#f3166b")
       (highlight-bg-color (color-desaturate-name (color-darken-name contrast-1-color 50) 10))
       ...
       (error (color-desaturate-name (color-darken-name contrast-2-color 30) 0))
